...
public class ActivityFoodPlaces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar supportToolbar_c=findViewById(R.id.supportv7_toolbar);
        setSupportActionBar(supportToolbar_c);
